...
typedef enum pj_stun_attr_type
{
    ...
    PJ_STUN_ATTR_STREAM_ID          = 0x802b,/**< Streamer ID attribute.    */
    PJ_STUN_ATTR_REMOTE_ADDR        = 0x802c,/**< NAT IP ADDRESS attribute. */
    ACK				    = 0x802d,/**< Acknowlegement.           */
    COMMAND_TYPE                    = 0x802e,/**< Command type.             */
    CONNECTION_TYPE                 = 0x802f,/**< Connection type.          */
    PJ_STUN_CAMERA_AVAILABLE        = 0x8030,/**< Camera available.         */
    PJ_STUN_COMMAND		    = 0x8031,/**< Command.                  */
    PJ_STUN_RANDOM_NUMBER           = 0x8032,/**< Random number.            */
    PJ_STUN_COMMAND_RESPONSE        = 0x8033,/**< Camera process response   */
    PJ_STUN_ATTR_END_EXTENDED_ATTR
...
typedef enum pj_stun_status
{
    ...
    CAMERA_NOT_CONNECTED                = 701,  /**< Camera not connected   */
    CAMERA_NOT_AVAILABLE                = 702,  /**< Camera not available   */
    PJ_STUN_UNEXPECTED_ATTRIBUTE        = 706,  /**< Unexpected attribute   */
    CMD_TYPE_INVALID                    = 707,  /**< Command type invalid   */
    CMD_RES_ERROR                       = 710   /**< Command response error */  
...
/**
 * This describes Stream ID attribute.
 * This attribute contains the stream ID for stun client-server communication
 * Its value is in string format. */
typedef struct pj_stun_string_attr pj_stun_stream_id_attr;

/**
 * This describes remote address attribute. */
typedef struct pj_stun_sockaddr_attr pj_stun_remote_addr_attr;

/**
 * This describes Acknowledgement attribute. */
typedef struct pj_stun_string_attr pj_stun_ack_attr;

/**
 * This describes command type attrbute for client availability and start and stop streaming. */
typedef struct pj_stun_string_attr command_type_attr;

/**
 * This describes connection type attribute of the instance of client. */
typedef struct pj_stun_string_attr connection_type_attr;

/**
 * This describes the camera availability attribute. */
typedef struct pj_stun_string_attr pj_stun_camera_available_attr;

/**
 * This describes the command attribute. */
typedef struct pj_stun_string_attr pj_stun_command_attr;

/**
 * This describes the random number. */
typedef struct pj_stun_string_attr pj_stun_random_number_attr;

/**
 * This describes the camera process command function response. */
typedef struct pj_stun_string_attr pj_stun_command_response;
/**
